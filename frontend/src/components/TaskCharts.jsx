      ...
      <Row gutter={[16]}>
        <Col span={12}>
          <Card title="Task Distribution" style={{ height: chartHeight + 80 }}>
            {hasPieData ? <Pie {...pieConfig} /> : <Empty description="No Data" />}
          </Card>
        </Col>
        <Col span={12}>
          <Card title="Task Priority Levels" style={{ height: chartHeight + 80 }}>
            {hasBarData ? <Column {...barConfig} /> : <Empty description="No Data" />}
          </Card>
        </Col>
      </Row>
    </>
